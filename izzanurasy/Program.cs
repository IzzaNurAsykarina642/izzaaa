...
class Program
{
    static void Main()
    {
        ...
        string[] makanan = { "Nasi Goreng", "Seblak", "Bakso", "Mie Rebus", "Mie Goreng", "Mie Ayam" };
        double[] hargaMakanan = { 12000, 10000, 8000, 7000, 8000, 10000 };

        // Array untuk daftar minuman dan harga
        string[] minuman = { "Teh Botol", "Teh Pucuk", "Es degan", "Es campur", "Kopi Susu", "Tea Jus" };
        double[] hargaMinuman = { 5000, 4000, 8000, 7000, 5000, 0 }; // Tea Jus gratis
